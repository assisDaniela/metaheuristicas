...
unsigned TSPP::getArcCost(int city1, int city2) {
  unsigned cost = graph[city1-1][city2-1];
  return cost;
}

unsigned TSPP::getPenalty(int city, int routePos) {
  return penalty[city-1][routePos];
}
